...
export const Navbar: React.FC = () => {
  ...
  return (
    <div className={`navbar-wrapper w-full ${isAtTop ? "bg-white" : "md:bg-[rgba(232,233,235)]"} flex justify-between px-[8%] lg:px-[16%] py-7 transition-colors duration-300`}>
      <div className="">
      ...
      <div className="gap-x-10 items-center hidden md:flex">
        ...
        <h2 className={`cursor-pointer hover:text-[#0B63E5] hover:duration-300 duration-300 ${isActive("/projects") ? "font-bold text-[#0B63E5]" : "text-[#42526B]"}`} onClick={() => redirect("/projects")}>
          Projects
        </h2>
        <h2 className={`cursor-pointer hover:text-[#0B63E5] hover:duration-300 duration-300 ${isActive("/services") ? "font-bold text-[#0B63E5]" : "text-[#42526B]"}`} onClick={() => redirect("/services")}>
          Services
        </h2>
        <h2 className={`cursor-pointer hover:text-[#0B63E5] hover:duration-300 duration-300 ${isActive("/about") ? "font-bold text-[#0B63E5]" : "text-[#42526B]"}`} onClick={() => redirect("/about")}>
          About Us
        </h2>
        <button className={`bg-[#0B63E5] rounded-md px-[20px] duration-300 py-[10px] text-[#FFFFFF] font-medium hover:cursor-pointer hover:opacity-80 transform hover:scale-105 ${isActive("/contact") ? "font-bold text-[#0B63E5]" : ""}`} onClick={() => redirect("/contact")}>
          Contact
        </button>
      </div>
