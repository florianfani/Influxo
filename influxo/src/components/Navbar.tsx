...
export const Navbar: React.FC = () => {
  ...
  return (
    <div
      className={`navbar-wrapper w-full ${
        isAtTop ? "bg-white" : "md:bg-[rgba(232,233,235)] md:shadow-lg"
      } flex justify-between px-[8%] xl:px-[16%] py-7 transition-all duration-1000`}
    >
      <div className="">
        <img
