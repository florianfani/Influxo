  ...
  return (
    <div className="navbar-wrapper flex justify-between px-[16%] py-7">
      ...
      <div className="flex gap-x-10 items-center">
        ...
        <button className="bg-[#0B63E5] rounded-md px-[20px] duration-300 py-[10px] text-[#FFFFFF] font-medium hover:cursor-pointer hover:opacity-80 transform hover:scale-105" onClick={() => redirect("/contact")}>
          Contact
        </button>
      </div>
    </div>
