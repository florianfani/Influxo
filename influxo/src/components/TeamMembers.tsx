...
const TeamMembers: React.FC = () => {
  ...
  return (
    <div className="py-10 px-[8%] xl:px-[16%] bg-[#F0F5FF]">
      ...
      <p className="text-center text-md text-[#42526B] mb-10">Praesent sagittis eros in convallis rutrum. Donec auctor nibh justo. Vestibulum tincidunt, libero sit amet vestibulum euismod, ex nisl imperdiet leo.</p>
