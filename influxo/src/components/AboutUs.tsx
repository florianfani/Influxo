...
const AboutUs: React.FC = () => {
  return (
    <div className="px-[8%] xl:px-0 xl:pl-[16%] xl:pr-[8%] flex flex-col lg:flex-row justify-between mb-[180px]">
      <div className="left-side lg:w-[45%] ">
        <div>
          <h2 className="text-[#061C3D] font-bold text-3xl xl:text-[56px]">
            About Us
          </h2>
          <p className="text-[#42526B] mt-10">
            At Influxo, we specialize in transforming ideas into exceptional web
            experiences.{" "}
            <span className="hidden lg:inline">
              <br />
            </span>{" "}
            Our team of experts combines advanced development techniques with
            creative solutions to deliver websites that not only look great but
            also perform flawlessly.{" "}
            <span className="hidden lg:inline">
              <br />
            </span>{" "}
            We’re passionate about crafting digital experiences that elevate
