...
const Services: React.FC = () => {
  ...
  return (
    <div className="px-[8%] xl:px-[16%] bg-[#F5F6F7] py-16">
      <div>
        <div className="">
          <h2 className="text-[56px] font-bold  mb-4 leading-tight">
            Our Services
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="hover:scale-105 duration-300  text-black flex flex-col bg-white  p-6 rounded-2xl shadow-lg hover:shadow-2xl"
            >
