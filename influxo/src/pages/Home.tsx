...
const Home: React.FC = () => {
  return (
    <div className="relative min-h-screen bg-white flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 py-16 flex flex-col lg:flex-row items-center justify-between">
        {/* Left Section */}
        <div className="lg:w-1/2">
          <span className="bg-[#FFE9BD] text-[#061C3D] py-1 px-3 rounded-full uppercase text-sm tracking-widest">
            Welcome to Influxo
          </span>
        ...
        <div className="lg:w-1/2 mt-12 lg:mt-0 relative">
          ...
          <div className="absolute inset-0 w-[115%] h-[100%] bg-gradient-to-r from-purple-400 to-purple-200 filter  opacity-95 z-0 transform -translate-x-1/8 -translate-y-1/5"></div>
          ...
          <div className="absolute -top-16 -left-10 w-100 h-100 bg-white  bg-transparent transform -translate-x-4 -translate-y-4">
            <img src={home1} alt="Icon 1" />
          </div>
          <div className="absolute -top-16 right-0 w-100 h-100 bg-white  bg-transparent transform translate-x-4">
            <img src={home2} alt="Icon 2" />
          </div>
          <div className="absolute -bottom-16  w-100 h-100 bg-white  bg-transparent transform -translate-x-8 translate-y-8">
